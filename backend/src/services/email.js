...
function textoAHtml(texto, link) {
  ...
  return escapado
    .replace(/\[link\]/g, `<a href="${link}" style="color:#1C6E63">${link}</a>`)
    .split('\n')
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">
        <tr><td style="padding:28px 32px 20px 32px;text-align:center;background-color:#1F2125;">
          <div style="font-size:28px;font-weight:600;letter-spacing:-0.5px;color:#ffffff;line-height:1;">lawkit<span style="display:inline-block;width:8px;height:8px;background-color:#1C6E63;border-radius:50%;margin-left:4px;vertical-align:baseline;"></span></div>
        </td></tr>
        <tr><td style="padding:28px 32px;font-size:15px;line-height:1.6;color:#334155;">
          ${cuerpo}
          <div style="text-align:center;margin:28px 0 8px 0;">
            <a href="${link}" style="display:inline-block;background-color:#1C6E63;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:600;font-size:15px;">
              Ver presupuesto
            </a>
          </div>
