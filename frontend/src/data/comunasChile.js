// Comunas de Chile agrupadas por región (16 regiones, 346 comunas)
// Fuente: Subsecretaría de Desarrollo Regional (SUBDERE).
...
export const COMUNAS_POR_REGION = {
  ...
  'Aysén': [
    ...
    "O'Higgins", 'Lago Verde', 'Río Ibáñez', 'Tortel',
  ],
  'Magallanes': [
